...
for i in range(0, max_num_frames):
    ...
    # synchronize depth and color and receive as frameset
    ...
    unaligned_depth_frame = colorizer.colorize(unaligned_depth_frame)
    npy_unaligned_depth_image = np.asanyarray(unaligned_depth_frame.get_data())
